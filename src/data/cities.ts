...
export const cities: City[] = [
  {
    ...
    name: "Beijing",
    region: "North China",
    tagline: "Ancient palaces, hutongs, and iconic landmarks.",
    bestFor: ["History", "Culture", "Must-visit"],
  ...
  },
  {
    ...
    name: "Shanghai",
    region: "East China",
    tagline: "Modern skyline, the Bund, and a dynamic city vibe.",
    bestFor: ["City Life", "Shopping", "River Views"],
    recommendedDays: "1-3 days",
  ...
  },
  {
    ...
    tagline: "Terracotta Warriors, ancient walls, and Silk Road heritage.",
  ...
  },
  {
    ...
    tagline: "Pandas, hot pot, tea houses, and laid-back living.",
    bestFor: ["Pandas", "Food", "Slow Life"],
    recommendedDays: "1-3 days",
  ...
  },
  {
    ...
    name: "Zhangjiajie",
    region: "Hunan",
    tagline: "Avatar-like peaks, cableways, and dramatic mountain scenery.",
    bestFor: ["Nature", "Scenery", "Adventure"],
    recommendedDays: "1-3 days",
  ...
  },
  {
    ...
    region: "Guangxi",
    tagline: "Stunning karst landscapes, rivers, bamboo rafts, and countryside views.",
